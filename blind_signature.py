...
def unblind_signature(public_key, signature_blinded, r):
    e, n = public_key
...
if __name__ == '__main__':
    ...
    blinded_message, r = blind_message(public_key, message)
    ...
    signature = unblind_signature(public_key, signature_blinded, r)
